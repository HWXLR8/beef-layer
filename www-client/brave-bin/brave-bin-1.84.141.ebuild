...
src_install() {
	...
	mv usr/share/doc/${BRAVE_PN} usr/share/doc/${PF} || die

	# Decompress the docs.
	gzip -d usr/share/doc/${PF}/changelog.gz || die
	gzip -d usr/share/man/man1/${BRAVE_PN}-stable.1.gz || die
	if [[ -L usr/share/man/man1/brave-browser.1.gz ]]; then
	    rm usr/share/man/man1/brave-browser.1.gz || die
	    dosym ${BRAVE_PN}-stable.1 usr/share/man/man1/brave-browser.1
	fi
